...
export class WasmRunner {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WasmRunnerFinalization.unregister(this);
        return ptr;
    }
    ...
    get model_name() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.wasmrunner_model_name(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    static cosine_similarity(a, b) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.wasmrunner_cosine_similarity(retptr, addBorrowedObject(a), addBorrowedObject(b));
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('rusty_llm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
